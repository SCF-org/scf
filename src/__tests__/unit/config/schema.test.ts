...
import { validateConfig, validateConfigSafe, configSchema } from '../../../core/config/schema.js';
...
describe('Config Schema Validation', () => {
  ...
  describe('validateConfig - CloudFront configuration', () => {
    it('should accept valid price classes', () => {
      const priceClasses = ['PriceClass_100', 'PriceClass_200', 'PriceClass_All'] as const;
